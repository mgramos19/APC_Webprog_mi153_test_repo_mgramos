...
Complete_Name = Nickname = E-mail_Address = Home_Address = Cell_No = "";
Complete_Name = $gender = Comment =  "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["email"])) {
    E-mail_Address = "Email is required";
  } else {
    E-mail_Address = test_input($_POST["email"]);
    
    if (!filter_var(E-mail_Address, FILTER_VALIDATE_EMAIL)) {
      E-mail_Address = "Invalid email format"; 
    }
  }
